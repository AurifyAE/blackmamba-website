...
export default function ShortStaysClient({
  property,
  seoData,
}: {
  property: Property
  ...
  const structuredData = {
    ...
    url: `https://www.blackmamba.realestate/shortstays/${property.id}`,
    numberOfRooms: seoData.propertyType.includes('3') ? '3' : '1',
    furnished: true,
    address: {
      '@type': 'PostalAddress',
      addressLocality: 'Dubai',
      addressCountry: 'AE',
      streetAddress: seoData.location,
    },
  }
  ...
  useEffect(() => {
    ...
    const esc = (e: KeyboardEvent) =>
      e.key === 'Escape' && setIsFloorPlanZoomed(false)
                    ...
                    >
                      {property.comingSoon ? (
                        ...
                        <Image
                          ...
                          fill
                          className={`object-cover transition-all duration-300 ${selectedImageIndex === index
                              ? 'scale-103'
                              : 'hover:scale-103'
                            }`}
                        />
              ...
              <div className="space-y-6">
                <div className="bg-gray-50 p-6 rounded-xl">
                  <h3 className="text-3xl font-semibold text-[#A97C50] mb-6">
                    {property.comingSoon ? 'Coming Soon' : property.shortStayPrice || 'Price on Request'}
                  </h3>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="pt-4">
                      ...
                      <div className="mt-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                        ...
                        >
                          {property.comingSoon ? 'Get Notified When Available' : 'Book Your Stay Now'}
                        </Link>
